...
<section class="apropos">
    <div class="admin-media-shell admin-form-shell">
        ...
        <form class="admin-form" method="POST" action="<?= route('admin_clients_update', ['id' => $client['id_client']]) ?>">
            ...
            <div class="admin-form-row"><label for="prenom">Prénom</label><input id="prenom" name="prenom" type="text" value="<?= e($client['prenom'] ?? '') ?>" required></div>
            ...
            <div class="admin-form-row"><label for="telephone">Téléphone</label><input id="telephone" name="telephone" type="text" value="<?= e($client['telephone'] ?? '') ?>"></div>
