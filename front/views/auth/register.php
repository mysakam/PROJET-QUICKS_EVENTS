...
<section class="apropos auth-section">
    <div class="admin-media-shell auth-shell">
        <div class="auth-copy">
            ...
            <p>Créez votre compte client pour accéder a votre espace personnel et préparer ensuite votre fiche événement.</p>

            <div class="auth-highlights">
                <div class="auth-highlight">Compte cree en quelques etapes</div>
                <div class="auth-highlight">Acces direct aux catalogues</div>
                <div class="auth-highlight">Fiche evenement apres inscription</div>
            </div>

            <a class="btn auth-side-link" href="<?= route('login') . $langQuery ?>">J'ai deja un compte</a>
        </div>

        <div class="admin-media-shell admin-form-shell auth-card">
            <h3 class="auth-card-title">Creer mon compte</h3>
